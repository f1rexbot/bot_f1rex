...
sinal = "/"
admins = []
permi = ["<Permissions value=8589934591>","<Permissions value=1071715446353>","<Permissions value=1071698669121>"]
...
async def recepição(ctx):
    if(str(ctx.author.guild_permissions) in permi):
        ...
        await ctx.send(f"{ctx.author.name} você não tem permisão para usar comandos")
